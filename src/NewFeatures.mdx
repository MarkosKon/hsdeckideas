            ...
            <tbody>
              <tr>
                ...
                <td>
                  ...
                  especially exciting because first of all it&apos;s fun to
                  create a filter and see what cards come out from the database.
                  For this to work a card will have different versions,
                  something that makes sense because the same card can be played
                  ...
                  way. So by submitting your ideas you will have fun and in the
                  same time you will help make this app better.
                </td>
                <td>
          ...
          <Table>
            ...
            <tbody>
              <tr>
                ...
                <td>
                  This project was one of my first projects while learning React
                  so as you can imagine I wrote a lot of bad code. During the
                  last month I&apos;m trying to simplify the codebase and make
                  it modern. I&apos;m doing that in an attempt to be easier to
                  add new features in the future (no pun intended).
                </td>
              </tr>
              <tr>
