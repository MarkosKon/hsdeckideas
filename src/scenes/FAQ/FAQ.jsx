...
, you can send me a message at
          ...
          {' '}
          <a href="https://www.facebook.com/hsdeckideas" target="_blank" rel="noopener noreferrer">
            Facebook
          </a>
          {' '}
          or
        ...
        <Donation>
          ...
          {' '}
          If you liked this app and want to see more frequent updates/features, please share the app
          to your friends or at social media. If you have the money to spare, you can also consider
          making a donation.
        </Donation>
        <DL>
          ...
          <DD>
            ...
            with priorities and then repeats the process. At some point the app tries to figure out
            what
            <b> type of deck (archetype) </b>
            we have so far in order to add some critical cards for that archetype. If the deck is
            still not complete, we add completely random good cards until is full. Also note that we
            always try to select the
            <b> best card </b>
