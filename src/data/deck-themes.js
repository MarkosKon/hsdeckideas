/*
    ...
    TODO They are class specific. Meaning one turn kill or buff cards are class
    specific and they are in general.
*/
const deckThemes = [
  /* Druid themes. */
  [
    ...
    },
    {
      ...
      name: 'Ramp',
      description:
        'Druid has the unique ability to cheat the curve with cards like Wild Growth and Innervate. ',
    ...
    },
    {
      ...
      decklistExtra: ['Ultimate Infestasion', 'The Lich King', "Y'Shaarj, Rage Unbound"],
      expansion: '3',
    },
    {
      /* (12) */
    ...
    },
    {
      ...
      sampleCards: ['Branching Paths', 'Oaken Summons', 'Lesser Jasper Spellstone'],
  ...
  [
    {
      ...
      decklistExtra: ['Southesea Captain', 'Captain Greenskin', 'Patches the Pirate'],
      expansion: '99',
    },
    {
      /* 2) */
    ...
    },
    {
      ...
      sampleCards: ['Professor Putricide', 'Venomstrike Trap', 'Wandering Monster'],
      decklistExtra: [],
      expansion: '9',
    },
    {
    ...
    },
    {
      ...
      sampleCards: ['Kathrena Winterwisp', 'Carnivorous Cube', 'Charged Devilsaur'],
    ...
    },
    {
      ...
      name: 'Trogg',
      description: '',
      sampleCards: ['Trogg Beastrager', 'Stonesplinter Trogg', 'Burly Rockjaw Trogg'],
    ...
    },
    {
      ...
      name: 'King',
      description: '',
      sampleCards: ['King Mukla', 'King Krush', 'Swamp King Dred'],
  ...
  [
    ...
    },
    {
      ...
      decklistExtra: ['Blackwing Corruptor', 'Azure Drake', 'Justicar Trueheart'],
      expansion: '3',
    },
    {
      /* 9) */
    ...
    // },
    {
      ...
      sampleCards: ['Open the Waygate', 'Primordial Glyph', 'Shimmering Tempest'],
      decklistExtra: [],
      expansion: '8',
    },
    {
      ...
      decklistExtra: ['Lesser Ruby Spellstone', 'Fire Fly', 'Leyline Manipulator'],
      expansion: '8',
    },
    {
      /* 15) */
      ...
      sampleCards: ['Molten Reflection', 'Faceless Manipulator', 'Faceless Shambler'],
    ...
    },
    {
      ...
      sampleCards: ['Leyline Manipulator', "Cabalist's Tome", 'Lesser Ruby Spellstone'],
    ...
    },
    {
      ...
      sampleCards: ['Leyline Manipulator', 'Fire Fly', 'Lesser Ruby Spellstone'],
      decklistExtra: [],
      expansion: '8',
    },
    {
  ...
  [
    {
      ...
      they usually have good stats for their mana cost. If play a class with weapons or throw
       patches in, you have a decent deck.`,
      sampleCards: ['Bloodsail Raider', 'Truesilver Champion', 'Southsea Deckhand'],
    ...
    },
    {
      ...
      description: `Paladin is one of the classes that can heal effectively. Not a 
      very effective strategy for aggressive decks.`,
      sampleCards: ['Lay on Hands', 'Lesser Pearl Spellstone', 'Benevolent Djinn'],
    ...
    },
    {
      ...
      spare. Other weapons can have unique, deck defining effects but in this case they lose you 
      tempo. `,
      sampleCards: ['Captain Greenskin', "Light's Justice", 'Truesilver Champion'],
    ...
    },
    {
      ...
      They get a lot of value in buff - board control decks. Also don't forget that you can 
      develop early in the game a big threat like Blood Knight. `,
      sampleCards: ['Righteous Protector', 'Howling Commander', "Light's Sorrow"],
    ...
    },
    {
      ...
      sampleCards: ['Anyfin Can Happen', 'Murloc Warleader', 'Bluegill Warrior'],
    ...
    },
    {
      ...
      sampleCards: ['Steward of Darkshire', 'Muster for Battle', 'Stand Against Darkness'],
    ...
    },
    {
      ...
      In addition they may land in the wrong minions or you maybe don't have any minios in
      your hand.`,
      sampleCards: ["Smuggler's Run", 'Grimestreet Enforcer', 'Grimestreet Outfitter'],
    ...
    },
    {
      ...
      summon Galvadon?`,
      sampleCards: ['The Last Kaleidosaur', 'Primalfin Champion', 'Lynessa Sunsorrow'],
    ...
    },
    {
      ...
      description: `This theme allows you to transform regular minions into big threats.
      The bad thing is that you must always have a minion on the board.`,
      sampleCards: ['Blessing of Kings', 'Spikeridged Steed', 'Silvermoon Portal'],
    ...
    },
    {
      ...
      description: `This theme allows you to transform regular minions into big threats.
      The bad thing is that you must always have a minion on the board.`,
      sampleCards: ['Blessing of Kings', 'Spikeridged Steed', 'Seal of Champions'],
    ...
    },
    {
      ...
      name: 'Argent',
      description: '',
      sampleCards: ['Argent Horserider', 'Argent Commander', 'Argent Protector'],
  ...
  [
    ...
    },
    {
      ...
      description: `This is a buff deck for Priest. Your goal is to stick a minion
      on the board and buff it. You can take trades or cast Inner Fire and go face.`,
      sampleCards: ['Power Word: Shield', 'Unidentified Elixir', 'Divine Spirit'],
      decklistExtra: ['Inner Fire'],
      expansion: '1',
    },
    {
    ...
    // },
    {
      ...
      sampleCards: ['Awaken the Makers', 'Crystalline Oracle', "Twilight's Call"],
  ...
  [
    ...
    },
    {
      ...
      you can choose where they attack which is very useful. Because of the stealth 
      they are also excellent in buff decks. Be careful though to not play them into a board clear. `,
      sampleCards: ['Valeera the Hollow', 'Shaku, the Collector', 'Shadow Sensei'],
    ...
    },
    {
      ...
      the unerfed Blade Flurry. Nowdays can be used as burst card with cheap charge minions or
       to buff Kingsbane.`,
      sampleCards: ["Tinker's Sharpsword Oil", 'Southsea Deckhand', 'Blade Flurry'],
    ...
    },
    {
      ...
      but they stick in the board. With cards like Kel'Thuzad, Baron Rivedare or N'Zoth 
      they can quickly go out of control. `,
      sampleCards: ['Kobold Illusionist', 'Roll the Bones', 'Lesser Onyx Spellstone'],
    ...
    },
    {
      ...
      decklistExtra: ['Stonetusk Boar', 'Southsea Deckhand', 'Sonya Shadowdancer'],
      expansion: '8',
    },
    {
      /* (18) */
      ...
      sampleCards: ['Razorpetal Lasher', 'Vilespine Slayer', 'Sherazin, Corpse Flower'],
  ...
  [
    {
      ...
      they usually have good stats for their mana cost. If play a class with weapons or throw
       patches in, you have a decent deck.`,
      sampleCards: ['Captain Greenskin', 'Southsea Deckhand', 'Bloodsail Raider'],
    ...
    },
    {
      ...
      Stormcaller`,
      sampleCards: ['Totemic Might', 'Tuskarr Totemic', 'Thunder Bluff Valiant'],
    ...
    },
    {
      ...
      decklistExtra: ['Totem Golem', 'Flamewreathed Faceless', 'Snowfury Giant'],
      expansion: '2',
    },
    {
      /* 8) */
    ...
    },
    {
      ...
      sampleCards: ['Thunder Bluff Valiant', 'Tuskarr Totemic', 'Draenei Totemcarver'],
      decklistExtra: [],
      expansion: '3',
    },
    {
    ...
    },
    {
      ...
      sampleCards: ['Everyfin is Awesome', 'Murloc Tidehunter', 'Call in the Finishers'],
    ...
    },
    {
      ...
      synergistic cards require you to play an elemental on the previous turn. That makes them minion
      heavy decks that play on curve.`,
      sampleCards: ['Fire Plume Harbinger', 'Stone Sentinel', 'Kalimos, Primal Lord'],
    ...
    },
    {
      ...
      sampleCards: ['Unite the Murlocs', 'Murloc Tidecaller', 'Gentle Megasaur'],
      decklistExtra: ['Murloc Warleader', 'Call in the Finishers', 'Rockpool Hunter'],
      expansion: '7',
    },
    {
      /* 19) */
    ...
    },
    {
      ...
      if you build your deck around it. Better to trigger the effect end game to take advantage
       of the extra mana.`,
      sampleCards: ['Windshear Stormcaller', 'Primal Talismans', 'Kobold Hermit'],
      decklistExtra: [],
      expansion: '10',
    },
    {
      ...
      sampleCards: ['Flamewreathed Faceless', 'Guild Recruiter', 'Injured Blademaster'],
      decklistExtra: [],
      expansion: '5',
    },
    {
      ...
      sampleCards: ['Lesser Sapphire Spellstone', 'Snowfury Giant', 'Ancestral Spirit'],
    ...
    },
    {
      ...
      name: 'Trogg',
      description: '',
      sampleCards: ['Tunnel Trogg', 'Stonesplinter Trogg', 'Burly Rockjaw Trogg'],
      decklistExtra: ['Trogg Gloomeater', 'Troggzor the Earthinator'],
      expansion: '1',
    },
  ],
  ...
  [
    ...
    },
    {
      ...
      sampleCards: ['Lakkari Sacrifice', 'Clutchmother Zavas', 'Cruel Dinomancer'],
  ...
  [
    ...
    },
    {
      ...
      they usually have good stats for their mana cost. If play a class with weapons or throw
       patches in, you have a decent deck.`,
      sampleCards: ["N'Zoth's First Mate", 'Bloodsail Cultist', 'Patches the Pirate'],
    ...
    },
    {
      ...
      sampleCards: ['Cruel Taskmaster', 'Frothing Berserker', 'Amani Berserker'],
      decklistExtra: [],
      expansion: '99',
    },
    {
      ...
      sampleCards: ['Iron Juggernaut', 'Youthful Brewmaster', 'Brann Bronzebeard'],
    ...
    },
    {
      ...
      description: `Taunt minions generally have poor stats for their cost and leave you behind in tempo. 
      Their advantage is that they can keep you alive against aggresive decks or force bad trades. `,
      sampleCards: ['Alley Armorsmith', "Fire Plume's Heart", 'Direhorn Hatchling'],
    ...
    },
    {
      ...
      sampleCards: ["Fire Plume's Heart", 'Direhorn Hatchling', 'Stonehill Defender'],
  ...
  [
    ...
    },
    {
      ...
      sampleCards: ['Twilight Drake', 'Twilight Guardian', 'Blackwing Corruptor'],
    ...
    },
    {
      ...
      description: `They usually have insane stats for their mana cost value wise. They are not good tempo plays 
        but they stick in the board. With cards like Kel'Thuzad, Baron Rivedare or N'Zoth 
        they can quickly go out of control. `,
      sampleCards: ['Baron Rivendare', 'Piloted Shredder', "Sneed's Old Shredder"],
    ...
    },
    {
      ...
      you can choose where they attack which is very useful. Because of the stealth 
      they are also excellent in buff decks. Be careful though to not play them into a board clear. `,
      sampleCards: ['Gilblin Stalker', 'Shade of Naxxramas', 'Stranglethorn Tiger'],
    ...
    },
    {
      ...
      you can choose where they attack which is very useful. Because of the stealth 
      they are also excellent in buff decks. Be careful though to not play them into a board clear. `,
      sampleCards: ['Sneaky Devil', 'Sabretooth Stalker', 'Stranglethorn Tiger'],
      decklistExtra: ['Worgen Infiltrator', 'Jungle Panther'],
      expansion: '8',
    },
    {
    ...
    },
    {
      ...
      sampleCards: ['Burly Rockjaw Trogg', 'Troggzor the Earthinator', 'Loatheb'],
    ...
    },
    {
      ...
      name: 'Double BGH',
      description:
        'No one expects a second Big Game Hunter. So it can be game winning choice in a control metagame. ',
    ...
    },
    {
      ...
      name: 'Grim Patron',
      description:
        'If your class has a way to deal 1 damage to the patron you can make a full board of them. ',
    ...
    },
    {
      ...
      sampleCards: ['Faerie Dragon', 'Arcane Nullifier X-21', 'Spectral Knight'],
      decklistExtra: [],
      expansion: '1',
    },
    {
    ...
    },
    {
      ...
      name: 'Giant',
      description:
        'Giants are big 8/8 bodies that can be tempo plays if their conditions are met. ',
    ...
    },
    {
      ...
      description: 'This is a subset of battlecry minions that can net you tempo when played. ',
    ...
    },
    {
      ...
      name: 'Silence benefits minions',
      description:
        'In this theme you can negate the downsides of some minions by silencing or by giving them taunt. ',
    ...
    },
    {
      ...
      description:
        'Do you feel that your opponent will have a good play next turn? Why not ruin it then? ',
    ...
    //   /* (48) PROB */
    //   name: 'Reno',
    //   description: `Some classes like Warlock have so many good cards that playing only
    //     1 copy of each cards is not a big problem. The ability is so powerful
    //     that slowed considerably the meta and made new decks viable.
    //     Every aggresive, mid range player has nightmares with this card. `,
    ...
    },
    {
      ...
      description: `This Old God needs you to put some powerful deathrattle minions in your deck. 
                          ...
                          your opponent.`,
      sampleCards: ["N'Zoth, the Corruptor", 'Twilight Summoner', 'Cairne Bloodhoof'],
      decklistExtra: [],
      expansion: '5',
    },
    {
    ...
    },
    {
      ...
      sampleCards: ["Y'Shaarj, Rage Unbound", 'The Lich King', 'Primordial Drake'],
      decklistExtra: [],
      expansion: '5',
    },
    {
    ...
    },
    {
      ...
      sampleCards: ['Tanaris Hogchopper', 'Spiked Hogrider', 'Leatherclad Hogleader'],
      decklistExtra: [],
      expansion: '7',
    },
    {
