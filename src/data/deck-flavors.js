...
const deckFlavors = [
  ...
  [
    ...
    },
    {
      ...
      name: 'Deathknight',
      description:
        "Why this Deathknight costs only 7 mana? One of the best Deathknight's for sure.",
    ...
    },
    {
      ...
      sampleCards: ['Ixlid, Fungal Lord', 'Ultimate Infestation', 'Jungle Giants'],
    ...
    },
    {
      ...
      sampleCards: ['Twig of the World Tree', 'Ultimate Infestation', 'Medivh, the Guardian'],
      decklistExtra: [],
      expansion: '6',
    },
    {
    ...
    },
    {
      ...
      sampleCards: ['Branching Paths', 'Spreading Plague', 'Lesser Emerald Spellstone'],
      decklistExtra: [],
      expansion: '10',
    },
    {
  ...
  [
    ...
    },
    {
      ...
      sampleCards: ['Steamwheedle Sniper', 'Auctionmaster Beardo', 'Justicar Trueheart'],
    ...
    },
    {
      ...
      description: 'Probably the best Hunter card of the Kobolds and Catacombs expansion.',
      sampleCards: ['Lesser Emerald Spellstone', 'Wandering Monster', 'Eaglehorn Bow'],
    ...
    },
    {
      ...
      description: 'Really good cards the cost and card that synergises with secrets.',
  ...
  [
    ...
    },
    {
      ...
      sampleCards: ['Archmage Antonidas', 'Mirror Image', "Sorcerer's Apprentice"],
    ...
    },
    {
      /* (5) */
      name: 'Deathknight',
      description: 'The goal is to make a water elemental every turn. A really powerful card.',
    ...
    },
    {
      ...
      sampleCards: ['Faceless Summoner', 'Injured Blademaster', 'Hyldnir Frostrider'],
  ...
  [
    ...
    },
    {
      ...
      description:
        "Doesn't matter what Paladin deck you're building, Sunkeeper Tarim fits in there.",
  ...
  [
    ...
    },
    {
      /* (2) */
      name: 'Shadowform',
      description: 'It is way worse than Raza + Anduin combo even after the Raza nerf.',
    ...
    },
    {
      ...
      sampleCards: ['Lyra the Sunshard', 'Radiant Elemental', 'Circle of Healing'],
    ...
    },
    {
      ...
      description: 'A really good card that almost always steals a card from your opponent.',
  ...
  [
    ...
    },
    {
      /* (7) */
      name: 'Shadowcaster',
      description: 'Maybe the best meme card in the game. It also not that bad.',
    ...
    },
    {
      ...
      and charge minions.`,
      sampleCards: ['Sonya Shadowdancer', 'The Caverns Below', 'Southsea Deckhand'],
  ...
  [
    ...
    },
    {
      /* (2) */
      name: 'Charged Hammer',
      description: 'A slow weapon that upgrades your hero power in the right deck.',
  ...
  [
    ...
    },
    {
      ...
      description: 'When everything else fails you can count on twisting nether.',
    ...
    },
    {
      /* (8) */
      name: 'Lord Jaraxxus',
      description: 'One of the most fun cards in Hearthstone that inspired the Deathknight cards.',
    ...
    },
    {
      /* (10) */
      name: 'Deathknight',
      description: 'The most expensive deathknight that usually wins you the game when played.',
    ...
    },
    {
      /* (13) */
      name: 'Bane of Doom',
      description: 'Not a very good card on average but can swing the game if you roll high.',
  ...
  [
    ...
    },
    {
      /* 7) */
      name: 'Blood Warriors',
      description: 'It can be used as a mediocre value card or in an Arcane Giant deck.',
    ...
    },
    {
      ...
      description: 'A powerful end of turn effect for 8 mana that can snowball the game.',
  ...
  [
    ...
    },
    {
      /* (11) */
      name: 'Nozdormu',
      description: 'Play it last in a complicated board and quickly hit the end turn button. ',
    ...
    },
    {
      ...
      sampleCards: ['Youthful Brewmaster', 'Ancient Brewmaster', 'Zola the Gorgon'],
      decklistExtra: [],
      expansion: '99',
    },
    {
    ...
    },
    {
      ...
      description: 'An infinite value card that is a demon but with terrible stat distribution. ',
    ...
    },
    {
      ...
      description:
        'A card that can make your hero power dreadful. Useful in control fatigue or inspire decks. ',
    ...
    },
    {
      ...
      description: "Good if you don't draw the card you should be playing, Sir Finley Mrrgglton. ",
    ...
    },
    {
      ...
      name: 'Arcane Giant',
      description: `This is one of the most used giants in Hearthstone. 
        It fits in decks that play cheap spells and have good cycle or in combo decks.`,
    ...
    },
    {
      ...
      sampleCards: ['Finja, the Flying Star', 'Murloc Warleader', 'Bluegill Warrior'],
      decklistExtra: [],
      expansion: '7',
    },
    {
    ...
    },
    {
      ...
      sampleCards: ['Patches the Pirate', 'Bloodsail Corsail', 'Southsea Captain'],
      decklistExtra: [],
      expansion: '',
    },
    {
    ...
    },
    {
      ...
      name: 'Feral Gibberer',
      description:
        "An interesting card that can become dangerous if you don't remove the first one.",
