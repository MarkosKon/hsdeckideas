...
const FAQ = () => {
  return (
    <div>
      <Header />
      <Panel bsStyle="info" style={{ marginTop: 20, border: 0 }}>
        <Panel.Heading
          style={{
            color: "black",
          ...
          <div className="col-md-8 col-md-offset-2">
            ...
            <dl>
              ...
              <dd>
                ...
                (i believe it was Trump) about a Malygos miracle rogue deck.
                That deck got popular and was the best deck after 1 year of the
                game's release. All good until now. The weird thing is that the
                deck had cards that were available from day 1. So, no one had
              ...
              <dd>
                ...
                Spells. Those cards are in yellow color. Finally if there are
                free spots left in the deck we fill it with completely random
                cards, the red ones.
              </dd>

              <dt>What do you mean by deck "archetype"?</dt>
              <dd>
                By saying deck archetype i mean what your deck tries to
                accomplish against other decks. For example if i tag a deck as
                aggro i mean that the deck will try to take the board in the
                early game and finish the game in the mid game. In contrast a
                control deck will usually try to remove early and mid game
                threats and win the game in the late game.
              </dd>

              <dt>What do you mean by deck "theme"?</dt>
              <dd>
                Deck theme is collection of cards that synergize well together.
                For example a dragon Priest deck evolves around dragons and
                their synergistic cards.
              </dd>

              <dt>What do you mean by deck "flavor"?</dt>
              <dd>
                Deck flavors are mainly good cards that don't necessarily need
                other cards to show their worth. For example think about Dr.
                Boom. It fits well in any archetype and theme but doesn't need
                N'Zoth and the deathrattle synergy to be worth it.
              </dd>
